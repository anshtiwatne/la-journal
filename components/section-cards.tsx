	...
	return (
		<div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
			<Card className="@container/card">
				<CardHeader>
					<CardDescription className='font-semibold text-black text-md'>LA Students</CardDescription>
			...
			<Card className="@container/card">
				<CardHeader>
					<CardDescription className='font-semibold text-black text-md'>Center Students</CardDescription>
					<CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
						20
					</CardTitle>
				</CardHeader>
